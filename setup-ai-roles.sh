...
echo "• 'you are now a qa engineer' - Switch to AI Quality Assurance Engineer role"

echo ""
echo "🔄 Alternative Commands:"
echo "• 'switch to developer/product/operations/designer/qa'"
echo "• 'developer mode', 'product mode', 'operations mode', 'design mode', 'qa mode'"
echo "• 'coding mode', 'strategy mode', 'devops mode', 'ux mode', 'testing mode'"
