  ...
  describe('generateScorecard - ACTUAL CALCULATIONS', () => {
    ...
    it('should handle static analysis issues with error severity', () => {
      const scorecard = generator.generateScorecard(
        ...
        { line: 85, branch: 80, function: 85 },
        { responseTime: 90, memoryUsage: 128 },
        { costPrevention: 12000, timeSaved: 4, userSatisfaction: 88 }
      );
    ...
    it('should handle static analysis issues with info severity', () => {
      const scorecard = generator.generateScorecard(
        ...
        { line: 90, branch: 85, function: 90 },
        { responseTime: 80, memoryUsage: 100 },
        { costPrevention: 15000, timeSaved: 5, userSatisfaction: 95 }
      );
