...
describe('ContextAwareTemplateEngine - Week 2 Enhanced', () => {
  let engine: ContextAwareTemplateEngine;
  ...
  describe('user level adaptation', () => {
    it('should adapt template for beginner users', async () => {
      const beginnerContext: TemplateContext = {
    ...
    it('should adapt template for advanced users', async () => {
      const advancedContext: TemplateContext = {
  ...
  describe('time constraint optimization', () => {
    it('should optimize for immediate time constraint', async () => {
      const immediateContext: TemplateContext = {
        toolName: 'smart_begin',
        taskType: 'generation',
        userLevel: 'intermediate',
        outputFormat: 'code',
    ...
    it('should optimize for thorough time constraint', async () => {
      const thoroughContext: TemplateContext = {
        toolName: 'smart_plan',
        taskType: 'planning',
        userLevel: 'advanced',
        outputFormat: 'structured',
  ...
  describe('context history integration', () => {
    it('should include context history in template variables', async () => {
      const contextWithHistory: TemplateContext = {
        toolName: 'smart_write',
        taskType: 'generation',
        userLevel: 'intermediate',
        outputFormat: 'code',
  ...
  describe('constraints handling', () => {
    it('should handle multiple constraints', async () => {
      const constrainedContext: TemplateContext = {
        toolName: 'smart_orchestrate',
        taskType: 'planning',
        userLevel: 'advanced',
        outputFormat: 'structured',
  ...
  describe('built-in templates', () => {
    it('should have built-in templates for common tools', () => {
      ...
      const smartBeginTemplate = templates.find((t: any) => t.toolName === 'smart_begin');
      const smartPlanTemplate = templates.find((t: any) => t.toolName === 'smart_plan');
      const smartWriteTemplate = templates.find((t: any) => t.toolName === 'smart_write');
