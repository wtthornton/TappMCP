...
export class BusinessContextBroker {
  private contextStore: Map<string, BusinessContext> = new Map();
  private roleHistory: Map<string, RoleTransition[]> = new Map();
   ...
   */
  getActiveContexts(): { key: string; context: BusinessContext; metadata: ContextMetadata }[] {
    const result: { key: string; context: BusinessContext; metadata: ContextMetadata }[] = [];
