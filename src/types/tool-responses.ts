...
export interface SmartFinishResponse {
  ...
  data?: {
    ...
    qualityScorecard: {
      ...
      quality: {
        testCoverage: { score: number; status: string };
        security: { score: number; status: string };
        complexity: { score: number; status: string };
        maintainability: { score: number; status: string };
      };
      business: {
        requirements: { score: number; status: string };
        value: { score: number; status: string };
        alignment: { score: number; status: string };
      };
      production: {
        securityScan: { status: string; score: number };
        performanceTest: { status: string; score: number };
        documentationComplete: { status: string; score: number };
        deploymentReady: { status: string; score: number };
      };
    };
    businessValue: {
