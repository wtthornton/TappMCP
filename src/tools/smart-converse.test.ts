...
describe('SmartConverse Tool', () => {
  ...
  describe('Handler Function', () => {
    ...
    it('should handle null input gracefully', async () => {
      const response = await handleSmartConverse(null as any);
    ...
    it('should handle undefined input gracefully', async () => {
      const response = await handleSmartConverse(undefined as any);
  ...
  describe('Intent Parsing', () => {
    ...
    it('should handle complex sentences with multiple keywords', () => {
      const intent = parseIntent(
        'I want to build and deploy a React web application with Node.js backend for testing'
      );
  ...
  describe('Smart Orchestrate Integration', () => {
    it('should call smart_orchestrate with correct parameters', async () => {
      ...
      expect(smartOrchestrate.handleSmartOrchestrate).toHaveBeenCalledWith(
    ...
    it('should pass tech stack to orchestrate', async () => {
      ...
      const callArgs = vi.mocked(smartOrchestrate.handleSmartOrchestrate).mock.calls[0][0] as any;
    ...
    it('should handle orchestrate errors gracefully', async () => {
      vi.mocked(smartOrchestrate.handleSmartOrchestrate).mockRejectedValue(
  ...
  describe('Response Generation', () => {
    ...
    it('should generate error response for failed orchestration', () => {
      const intent = {
        ...
        projectType: 'api-service' as const,
        techStack: [],
        role: 'developer' as const,
