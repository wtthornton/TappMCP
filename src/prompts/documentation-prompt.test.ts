...
describe('DocumentationPrompt', () => {
  describe('Schema Validation', () => {
    ...
    it('should validate all style enum values', () => {
      const styles = ['jsdoc', 'tsdoc', 'sphinx', 'markdown', 'asciidoc', 'plain'] as const;
    ...
    it('should validate all audience enum values', () => {
      const audiences = ['developer', 'end-user', 'maintainer', 'beginner', 'expert'] as const;

      for (const audience of audiences) {
        const input = {
          code: 'sample code',
          language: 'typescript',
          docType: 'class' as const,
          audience,
        };
...
app.listen(port, () => {
  console.log(\`Server running on port \${port}\`);
    ...
    it('should generate different prompts for different audiences', async () => {
      ...
      const audiences = ['developer', 'beginner', 'expert', 'end-user', 'maintainer'] as const;
