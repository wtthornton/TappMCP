...
describe('ResourceLifecycleManager', () => {
  ...
  let mockResource: MockMCPResource;
  let mockLogger: any;
  ...
  describe('Lifecycle Management', () => {
    ...
    it('should stop lifecycle management', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(
        'Resource lifecycle management stopped',
        expect.any(Object)
      );
    });
  ...
  describe('Force Cleanup', () => {
    ...
    it('should perform force cleanup of all resources', async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(
        'Force cleanup of all resources initiated',
        expect.any(Object)
      );
      expect(mockLogger.info).toHaveBeenCalledWith(
        'Force cleanup of all resources completed',
        expect.any(Object)
      );
    });
  });
  ...
  describe('Destroy', () => {
    ...
    it('should destroy manager and cleanup resources', async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(
        'Resource lifecycle manager destroyed',
        expect.any(Object)
      );
    });
  });
