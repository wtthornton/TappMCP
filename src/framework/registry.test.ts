...
class TestMCPTool extends MCPTool<{ input: string }, { output: string }> {
  ...
  protected async executeInternal(input: { input: string }): Promise<{ output: string }> {
...
class TestMCPPrompt extends MCPPrompt<{ name: string }, string> {
  constructor() {
    super({
      name: 'test-prompt',
...
describe('MCPRegistry', () => {
  ...
  describe('Registry Statistics', () => {
    ...
    it('should track unhealthy components', async () => {
      ...
      class UnhealthyTool extends MCPTool<{ input: string }, { output: string }> {
        constructor() {
          super({
            name: 'unhealthy-tool',
