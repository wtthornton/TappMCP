...
import { createRealMCPClient } from '../external/RealMCPClient';
        ...
        it('should execute real tools on connected MCP servers', async () => {
            ...
            for (const serverName of connectedServers) {
                ...
                try {
                    ...
                    console.log(`📋 ${serverName} available tools: ${tools.map((t) => t.name).join(', ')}`);
                    if (tools.length > 0) {
...
//# sourceMappingURL=prove-real-mcp.test.js.map