...
export class CodeGenerationPrompt extends MCPPrompt {
     ...
     */
    async generateWithPattern(input, pattern, context) {
     ...
     * Generate test code
     */
    async generateTests(input, testFramework, context) {
        const testContext = {
            ...input,
            includeTests: true,
            requirements: [
     ...
     */
    async optimizeCode(code, language, optimizationGoals, context) {
...
//# sourceMappingURL=code-generation-prompt.js.map