...
export class CodeReviewPrompt extends MCPPrompt {
     ...
     */
    async securityReview(code, language, context) {
        const input = {
            code,
            language,
            reviewType: 'security',
     ...
     */
    async performanceReview(code, language, context) {
        const input = {
            code,
            language,
     ...
     */
    async maintainabilityReview(code, language, context) {
        const input = {
            code,
            language,
     ...
     */
    async generateReviewChecklist(_language, reviewType, _context) {
        const checklists = {
            security: [
...
//# sourceMappingURL=code-review-prompt.js.map