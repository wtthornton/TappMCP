...
export class DocumentationPrompt extends MCPPrompt {
     ...
     */
    async generateApiDocs(code, language, style = 'markdown', context) {
        const input = {
            code,
            language,
            docType: 'api',
     ...
     */
    async generateReadme(code, language, projectName, context) {
        const input = {
            code,
            language,
            docType: 'readme',
     ...
     */
    async generateTutorial(code, language, topic, context) {
        const input = {
            code,
            language,
            docType: 'tutorial',
     ...
     */
    async generateFunctionDocs(code, language, style = 'jsdoc', context) {
        const input = {
            code,
            language,
            docType: 'function',
     ...
     */
    async generateClassDocs(code, language, style = 'jsdoc', context) {
        const input = {
            code,
            language,
            docType: 'class',
...
//# sourceMappingURL=documentation-prompt.js.map