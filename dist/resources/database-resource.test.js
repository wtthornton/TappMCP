...
import { DatabaseResource } from './database-resource.js';
...
describe('DatabaseResource', () => {
    ...
    describe('Connection Pool Management', () => {
        it('should manage connection pool correctly', async () => {
            ...
            const configs = [
                { operation: 'query', table: 'users', orderDirection: 'ASC' },
                { operation: 'query', table: 'products', orderDirection: 'ASC' },
                { operation: 'query', table: 'orders', orderDirection: 'ASC' },
            ];
            const results = await Promise.all(configs.map(config => databaseResource.executeOperation(config)));
    ...
    describe('Health Check', () => {
        ...
        it('should return unhealthy status when connections fail', async () => {
            ...
            databaseResource.getConnection = vi
                .fn()
    ...
    describe('Error Handling', () => {
        it('should handle unexpected errors gracefully', async () => {
            ...
            vi.spyOn(databaseResource, 'runQuery').mockRejectedValue(new Error('Unexpected database error'));
            const config = {
                operation: 'query',
                table: 'users',
                orderDirection: 'ASC',
...
//# sourceMappingURL=database-resource.test.js.map