...
export class ApiResource extends MCPResource {
     ...
     */
    async executeWithRetries(config, startTime) {
        let lastError = null;
     ...
     */
    simulateResponse(config, url, _headers) {
     ...
     * Check rate limiting
     */
    async checkRateLimit(url, rateLimit) {
...
//# sourceMappingURL=api-resource-mock.js.map