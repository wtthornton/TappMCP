...
describe('OrchestrationEngine', () => {
    ...
    describe('switchRole', () => {
        it('should create a valid role transition', async () => {
            const transition = await engine.switchRole('business-analyst', 'developer', sampleBusinessContext);
        ...
        it('should preserve context during role transition', async () => {
            const transition = await engine.switchRole('product-manager', 'qa-engineer', sampleBusinessContext);
    ...
    describe('validateWorkflow', () => {
        ...
        it('should identify missing business context', () => {
            const invalidWorkflow = { ...sampleWorkflow, businessContext: undefined };
            const validation = engine.validateWorkflow(invalidWorkflow);
            expect(validation.isValid).toBe(false);
        ...
        it('should set workflow status to failed on error', async () => {
            const errorWorkflow = {
                ...
                phases: [
                    {
                        ...sampleWorkflow.phases[0],
                        tools: null, // This should cause an error
                    },
                ],
            };
...
//# sourceMappingURL=orchestration-engine.test.js.map