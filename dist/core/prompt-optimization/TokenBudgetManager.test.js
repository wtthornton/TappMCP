...
import { TokenBudgetManager, createTokenBudgetManager } from './TokenBudgetManager';
describe('TokenBudgetManager', () => {
    ...
    describe('alternatives generation', () => {
        it('should provide alternatives for rejected requests', async () => {
            ...
            expect(approval.approved).toBe(false);
            expect(approval.alternatives).toBeDefined();
            expect(approval.alternatives?.reducedTokens).toBeLessThan(expensiveRequest.estimatedInputTokens);
    ...
    describe('factory function', () => {
        ...
        it('should create manager with custom configuration', () => {
            const customManager = createTokenBudgetManager({ costPerInputToken: 0.00005 }, { dailyBudget: 50 });
            expect(customManager).toBeInstanceOf(TokenBudgetManager);
        });
    });
});
//# sourceMappingURL=TokenBudgetManager.test.js.map