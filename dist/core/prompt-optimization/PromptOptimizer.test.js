    ...
    describe('optimization strategies', () => {
        it('should apply compression strategy', async () => {
            const request = {
                ...
                originalPrompt: 'Please create a detailed implementation of a complex function with multiple parameters and comprehensive error handling.',
                context: {
                    taskType: 'generation',
    ...
    describe('budget integration', () => {
        it('should respect token budget limits', async () => {
            const request = {
                ...
                originalPrompt: 'Write a very comprehensive, detailed, thorough, and extensive explanation with many examples and comprehensive coverage of all aspects'.repeat(20),
                context: {
                    taskType: 'generation',
                    userLevel: 'intermediate',
                    outputFormat: 'text',
