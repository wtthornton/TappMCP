...
import { SmartBeginMCPTool } from './smart-begin-mcp.js';
describe('SmartBeginMCPTool', () => {
    ...
    describe('Business Value Calculation', () => {
        it('should calculate higher business value for complex tech stacks', async () => {
            ...
            expect(complexResult.data?.businessValue.costPrevention).toBeGreaterThan(simpleResult.data?.businessValue.costPrevention || 0);
            expect(complexResult.data?.businessValue.timeSaved).toBeGreaterThan(simpleResult.data?.businessValue.timeSaved || 0);
        });
    });
...
//# sourceMappingURL=smart-begin-mcp.test.js.map