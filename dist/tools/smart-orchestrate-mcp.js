...
import { BusinessContextBroker } from '../core/business-context-broker.js';
...
export class SmartOrchestrateMCPTool extends MCPTool {
    orchestrationEngine;
    contextBroker;
    _mcpCoordinator; // Used for external knowledge gathering (currently commented out)
    constructor() {
        super(config);
    ...
    async executeInternal(input, _context) {
        ...
        this.contextBroker.setContext(`project:${businessContext.projectId}:context`, businessContext, 'system');
     ...
     */
    generateEnhancedWorkflowPhases(_workflowType, request, options) {
        const phases = [];
     ...
     */
    generateNextSteps(workflowResult, _businessContext) {
        const nextSteps = [];
...
//# sourceMappingURL=smart-orchestrate-mcp.js.map