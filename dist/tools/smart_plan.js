...
const SmartPlanInputSchema = zod_1.z.object({
    ...
    planType: zod_1.z.enum(["development", "testing", "deployment", "maintenance", "migration"]).default("development"),
    ...
    externalMCPs: zod_1.z.array(zod_1.z.object({
        name: zod_1.z.string(),
    ...
    qualityRequirements: zod_1.z.object({
        ...
        performanceTargets: zod_1.z.object({
