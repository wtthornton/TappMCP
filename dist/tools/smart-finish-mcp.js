 ...
 */
export class SmartFinishMCPTool extends MCPTool {
     ...
     */
    async generateQualityScorecard(input, _businessRequirements) {
     ...
     * Calculate business value
     */
    calculateBusinessValue(_businessRequirements, qualityScorecard) {
     ...
     * Check production readiness
     */
    async checkProductionReadiness(productionReadiness, qualityScorecard) {
        const results = {
            securityScan: {
                passed: false,
                score: 0,
     ...
     * Generate next steps
     */
    generateNextSteps(qualityScorecard, productionReadiness) {
        const steps = [];
     ...
     * Generate recommendations
     */
    generateRecommendations(qualityScorecard, productionReadiness) {
        const recommendations = [];
...
//# sourceMappingURL=smart-finish-mcp.js.map