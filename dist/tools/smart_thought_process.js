...
exports.SmartThoughtProcessInputSchema = void 0;
exports.handleSmartThoughtProcess = handleSmartThoughtProcess;
...
const SmartThoughtProcessInputSchema = zod_1.z.object({
    projectId: zod_1.z.string().min(1, 'Project ID is required'),
    codeId: zod_1.z.string().optional(),
...
exports.SmartThoughtProcessInputSchema = SmartThoughtProcessInputSchema;
 ...
 */
async function handleSmartThoughtProcess(input) {
    ...
    try {
        ...
        const response = {
            ...
            summary: {
                ...
                qualityScore: Object.values(thoughtProcess.step4_validation.qualityMetrics).filter(metric => metric === 'Excellent').length / Object.keys(thoughtProcess.step4_validation.qualityMetrics).length * 100
            },
            technicalMetrics: {
...
//# sourceMappingURL=smart_thought_process.js.map